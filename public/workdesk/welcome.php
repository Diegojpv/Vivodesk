...
<body>
    ...
    <main class="wd-welcome">
        <div class="wd-welcome__content">
            <div class="wd-welcome__text">
                <h1><?php echo "Welcome to your work desk \n" . htmlspecialchars($username) ."!"?></h1>
                <p>Enter one of the sections and start working</p>
            </div>
            <div class="loader">
        <div class="wrapper">
